...
def run_scraper(f_name, output_f, output_n):
    html_file_to_import = f_name
    # in v2, all of these file paths will go from hardcoded to a GUI - should be coded to support macOS

    csv_to_exportRAW = output_f + "/" + output_n + "_raw.csv"
    csv_to_exportFINE = output_f + "/" + output_n + "_fine.csv"
